...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,276 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - Bandit is a tool designed to find common security issues in Python code.
...
* [Safety](https://github.com/pyupio/safety) ⭐ 1,997 | 🐛 97 | 🌐 Python | 📅 2026-09-04 - Safety checks your installed dependencies for known security vulnerabilities.
...
* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,269 | 🐛 21 | 🌐 Python | 📅 2026-09-18 - Bleeding edge `django` template focused on code quality and security.
