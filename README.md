...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,259 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Bandit is a tool designed to find common security issues in Python code.
...
* [Safety](https://github.com/pyupio/safety) ⭐ 1,997 | 🐛 98 | 🌐 Python | 📅 2026-09-04 - Safety checks your installed dependencies for known security vulnerabilities.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,438 | 🐛 32 | 🌐 Python | 📅 2026-09-14 - Automatic SQL injection and database takeover tool
...
* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,268 | 🐛 21 | 🌐 Python | 📅 2026-09-11 - Bleeding edge `django` template focused on code quality and security.
