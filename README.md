...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,999 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,258 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Bandit is a tool designed to find common security issues in Python code.
...
* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,270 | 🐛 21 | 🌐 Python | 📅 2026-09-11 - Bleeding edge `django` template focused on code quality and security.
