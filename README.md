...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,979 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,271 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - Bandit is a tool designed to find common security issues in Python code.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,458 | 🐛 31 | 🌐 Python | 📅 2026-09-15 - Automatic SQL injection and database takeover tool
...
* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,269 | 🐛 21 | 🌐 Python | 📅 2026-09-14 - Bleeding edge `django` template focused on code quality and security.
