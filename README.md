...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,224 | 🐛 259 | 🌐 Python | 📅 2026-08-04 - Bandit is a tool designed to find common security issues in Python code.
...
* [Safety](https://github.com/pyupio/safety) ⭐ 1,994 | 🐛 90 | 🌐 Python | 📅 2026-08-20 - Safety checks your installed dependencies for known security vulnerabilities.
...
* [EvilTwinFramework](https://github.com/Esser420/EvilTwinFramework) ⭐ 358 | 🐛 8 | 🌐 Python | 📅 2024-08-01 - A framework for pentesters that facilitates evil twin attacks as well as exploiting other wifi vulnerabilities.

## Cryptography

* [Passlib](https://bitbucket.org/ecollins/passlib) - Secure password storage/hashing library, very high level.
* [PyNacl](https://github.com/pyca/pynacl) ⭐ 1,204 | 🐛 56 | 🌐 C | 📅 2026-08-18 - Python binding to the Networking and Cryptography (NaCl) library.

## Application Templates

* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,268 | 🐛 23 | 🌐 Python | 📅 2026-08-17 - Bleeding edge `django` template focused on code quality and security.
