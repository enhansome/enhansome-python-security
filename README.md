...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,226 | 🐛 259 | 🌐 Python | 📅 2026-08-04 - Bandit is a tool designed to find common security issues in Python code.
...
* [Safety](https://github.com/pyupio/safety) ⭐ 1,994 | 🐛 92 | 🌐 Python | 📅 2026-08-20 - Safety checks your installed dependencies for known security vulnerabilities.
...
* [PyNacl](https://github.com/pyca/pynacl) ⭐ 1,204 | 🐛 57 | 🌐 C | 📅 2026-08-18 - Python binding to the Networking and Cryptography (NaCl) library.
