...
* [Secure.py](https://github.com/cakinney/secure.py) ⭐ 1,054 | 🐛 9 | 🌐 Python | 📅 2026-09-01 - secure.py 🔒 is a lightweight package that adds optional security headers and cookie attributes for Python web frameworks.
...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,254 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - Bandit is a tool designed to find common security issues in Python code.
...
* [Safety](https://github.com/pyupio/safety) ⭐ 1,996 | 🐛 98 | 🌐 Python | 📅 2026-09-04 - Safety checks your installed dependencies for known security vulnerabilities.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,387 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool
...
* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,271 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - Bleeding edge `django` template focused on code quality and security.
...
* [DVPWA](https://github.com/anxolerd/dvpwa) ⭐ 194 | 🐛 12 | 🌐 Python | 📅 2024-05-21 - Damn Vulnerable Python Web Application was inspired by famous dvwa project and bobby-tables xkcd comics.
