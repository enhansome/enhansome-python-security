...
* [Secure.py](https://github.com/cakinney/secure.py) ⭐ 1,062 | 🐛 9 | 🌐 Python | 📅 2026-09-01 - secure.py 🔒 is a lightweight package that adds optional security headers and cookie attributes for Python web frameworks.
...
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,281 | 🐛 258 | 🌐 Python | 📅 2026-09-21 - Bandit is a tool designed to find common security issues in Python code.
...
* [DSVW](https://github.com/stamparm/DSVW) ⭐ 882 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - Damn Small Vulnerable Web (DSVW) is a deliberately vulnerable web application written in under 100 lines of code, created for educational purposes.
